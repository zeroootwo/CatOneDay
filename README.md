...
![Build Status](https://github.com/zeroootwo/CatOneDay/actions/workflows/build.yml/badge.svg)
...
1. Перейдите во вкладку [Releases](https://github.com/zeroootwo/CatOneDay/releases) (или скачайте из Artifacts в последней сборке).
2. Распакуйте архив.
